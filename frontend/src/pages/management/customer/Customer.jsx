  ...
  return (
    <div className="min-h-screen bg-background transition-all duration-300 p-4 sm:p-6 md:p-10 transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-card transition-colors duration-300 rounded-[2rem] md:rounded-[3rem] border border-border shadow-sm min-h-[600px] overflow-hidden">
          ...
          <div className="animate-in fade-in duration-500 w-full h-full">
            ...
            {activeTab === 'status' && (
               <div className="py-24 text-center flex flex-col items-center">
                  <ShieldAlert className="text-primary transition-all duration-300 mb-6 opacity-20" size={64} />
                  <h3 className="text-xl font-serif italic text-textMain/50 transition-colors duration-300">Credit monitoring is being synced</h3>
                  <p className="text-textMain/50 transition-colors duration-300 text-[9px] mt-2 uppercase font-bold tracking-widest text-center">Version 1.0.4 Data Link Active</p>
               </div>
            )}
            ...
            {activeTab === 'delete' && (
               <div className="p-10 text-left">
                  ...
                  <div className="p-10 border-2 border-dashed border-border rounded-[2rem] text-center">
                    ...
                    <p className="text-textMain/50 transition-colors duration-300 text-[10px] font-black uppercase tracking-widest">Archive portal is restricted to root administrators</p>
                  </div>
               </div>
            )}
          </div>
