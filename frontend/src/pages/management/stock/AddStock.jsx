    ...
    <div className="w-full max-w-7xl mx-auto p-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-4">
        <div>
          ...
          <p className="text-textMain/50 transition-colors duration-300 text-sm mt-2 ml-14 font-medium">Add and manage product stock levels across variants.</p>
        </div>
        ...
        <div className="lg:col-span-7">
          <div className="bg-card transition-colors duration-300 border border-border transition-colors duration-300 rounded-4xl shadow-sm overflow-hidden">
            <div className="p-5 border-b border-border transition-colors duration-300 bg-card/50 transition-colors duration-300 flex items-center justify-between">
              ...
              <span className="text-[10px] font-black text-primary transition-all duration-300 uppercase tracking-widest">Click Product To Queue</span>
            </div>
                      ...
                      {product.variants.map((variant) => (
                        <div key={variant.variant_id} className="grid grid-cols-[1fr_auto] gap-3 items-center">
                          <div>
                            ...
                            <p className="text-[10px] text-textMain/50 transition-colors duration-300 font-semibold">{variant.stock_count} units • Rs. {variant.price.toLocaleString()} each</p>
                          </div>
                          <input
                            type="number"
                            min="1"
                            ...
                            placeholder="Qty"
                            className="w-20 px-3 py-2 rounded-lg border border-border transition-colors duration-300 text-sm font-semibold outline-none focus:border-primary transition-all duration-300 focus:ring-2 focus:ring-[#b4a460]/20"
                          />
                        </div>
                      ))}
